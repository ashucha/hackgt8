...
function calcTime(latitude, longitude, store) {
    ...
    const walkingSpeed = 6.4, drivingSpeed = 80;
    let dist = getDistanceFromLatLonInKm(latitude, longitude, store.coordinates.latitude, store.coordinates.longitude);
...
function getGoogleMapsLink(store) {
    return "https://www.google.com/maps?q=" + store.coordinates.latitude + "," + store.coordinates.longitude;
}
